...
| `VITE_API_BASE`  | Базовый URL API бэкенда (для запросов из браузера) |
| `VITE_INTERNAL_API_BASE` | Базовый URL API бэкенда для серверных (SSR) запросов внутри Docker-сети |
