...
npm-run test:all      # Запуск всех видов тестов (финальная проверка)
...
- Перед созданием ветки и коммитами запусти `npm run lint` и `npm run test:all`, если все успешно, то продолжай
...
- При пуше убедись, что все нужное закомиченно
- Название коммитов всегда начинается с какого-то действия
- Перед коммитом проверять какие файлы коммитишь
